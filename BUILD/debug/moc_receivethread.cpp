...
QT_MOC_LITERAL(1, 14, 16), // "datagramReceived"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 18), // "fbDatagramReceived"
QT_MOC_LITERAL(4, 51, 23) // "processPendingDatagrams"

    },
    "receiveThread\0datagramReceived\0\0"
    "fbDatagramReceived\0processPendingDatagrams"
};
...
void receiveThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->datagramReceived(); break;
        case 1: _t->fbDatagramReceived(); break;
        case 2: { int _r = _t->processPendingDatagrams();
        ...
        {
            using _t = void (receiveThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&receiveThread::datagramReceived)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (receiveThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&receiveThread::fbDatagramReceived)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void receiveThread::datagramReceived()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void receiveThread::fbDatagramReceived()
{
